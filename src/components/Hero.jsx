            ...
            <div>
                ...
                <div className="flex flex-col items-center justify-center gap-y-3 font-light capitalize">
                    <motion.div className="flex  items-center justify-center" style={{
                        ...
                        <Image className="w-60 h-60 overflow-hidden rounded-full" src='/skills/big-hero-3.webp' alt="Person Image" width={160} height={160} priority={true} />
                    ...
                    <p className=" text-lg tracking-wider text-gray-700 "> I like to build 😎</p>
                ...
                <div className="flex felx-col justify-center items-center mt-8 gap-x-10 text-3xl text-blue-600 sm:text-2xl">
                    {heroIcons.map((icon, key) => (
                        <a href="#" key={key} className="hover:bg-blue-400 hover:text-white rounded-lg">{icon} </a>
                    ))}


                </div>
                <a href="#" className=" mx-auto mt-7  block w-max rounded-lg bg-blue-400 px-3 py-1 capitalize tracking-wider text-white hover:bg-blue-700 transition-colors "
